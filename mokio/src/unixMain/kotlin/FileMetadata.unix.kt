...
internal actual fun systemSetFileMetadata(
    ...
    if (setTimes) {
        ...
        try {
            val lastAccessTime = attributes.get<Attribute.Time.LastAccess>()?.time
            val lastModifiedTime = attributes.get<Attribute.Time.LastModified>()?.time
            ...
            attributes.get<Attribute.Time.Creation>()?.time?.let {
...
internal fun timespec.toInstant() =
